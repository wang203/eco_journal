...
%(I doubt this number. This is because the ground truth put too many bins in gray area while there are too many non-green bins on the north that we do not really care.) 
...
%\includegraphics[width=0.10\textwidth]{imggrid/falseposi/1.jpg} &
%\includegraphics[width=0.10\textwidth]{imggrid/falseposi/2.jpg} &
...
Generally, all the false negative error is due to the sparseness of data. While not enough images are collected at certain location during some time, there is either no green image found or green images are too few compare to the quantity of non-green images. On the other hand, false positive error is rare (less than 1\%) and complex. We found most images in the false positive bins are actually green vegetation images. 
\fxnote{here we need some more explanation} 
...
%%%%%%%%%%%%    why this part     %%%%%%%%%%%%%%%%%
%%This is the result of vegetation case in www paper.
%%I guess this might help us to explain why we do not use tag in vege case in this paper.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
...
%\begin{center}
%\begin{tabular}{@{}c@{\,\,\,}c@{\,\,\,}c@{\,\,\,}c@{\,\,\,}c@{\,\,\,}}
%\includegraphics[width=0.10\textwidth]{imggrid/datasetposi/1.jpg} &
