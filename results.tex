...
at 80.5\%. However, CNN achieve the best performance at 88.06\%  
...
\fxnote{here we need some more explanation about why in false positive bins, we found many green images.} 
...
\fxnote{This is an advantage of our work, the most important thing Ecologists would be interested in, is when do the leaves change color in each location. And ground truth usually shows missing data for that time period while we don't.}
% bar plot of 2 places
\begin{figure}
%{\small{
\begin{center}
