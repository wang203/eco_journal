...
number of positive and non-positive photos in each bin. 
...
\begin{itemize}
	...
	chi-squared distance (as in ~\cite{xiao2010sun}).
...
\fxnote{We probably want to keep this since we mentioned it in figure ~\ref{city_roc}.}
