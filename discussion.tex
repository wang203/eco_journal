...
%Discussion about the fact that tags really don't work well for some
...
Our experiments also provide evidence for the latest improvements in image classification -- CNN outperforms traditional vision technique when
 we have a large number of training data. The reason is not completely understood. Intuitively, deep learning technique integrates feature learning
 and classification and enables global optimization while
...
Look at time series of photos at a single place across time \fxnote{Sorry I don't understand this well enough}
